...
ALLOWED_ROLE_IDS = [1310673963000528949, 1381682246678741022, 1223589384452833290, 1501905377514488039]  # Роли с доступом к командам
...
async def bot_status(interaction: discord.Interaction):
    try:
        ...
        embed.add_field(
            ...
            value=f"```Tier: {tier_count} | Warn: {warn_count}```", 
            inline=False
        )
